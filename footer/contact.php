...
<section class="contact-page">
    ...
    <div class="contact-info">
        <div class="c-info"><img src="<?php echo $_SESSION['base']?>/images/icons8-mail-32.png" alt=""> E-mail: radionica.3D@outlook.com</div>
        <div class="c-info"><img src="<?php echo $_SESSION['base']?>/images/icons8-phone-32.png" alt="">Broj telefona: 062/843/319/2</div>
        <div class="c-info"><img src="<?php echo $_SESSION['base']?>/images/icons8-location-32.png" alt="">Lokacija: 34310 Topola</div>
    </div>
</section>
